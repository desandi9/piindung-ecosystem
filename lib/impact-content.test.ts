...
test("impact content rejects duplicates and malformed data", () => {
  ...
  assert.throws(() => validateImpactContent({ ...DEFAULT_IMPACT_CONTENT, stories: [{ id: "c", title: "A", excerpt: "E", body: "B", status: "published", featured: true, position: 0 }] })) // missing publishedAt
})
