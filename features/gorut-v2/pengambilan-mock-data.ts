...
const seeds: BatchSeed[] = [
  { period: '2026-07', plpkId: 'PLPK-01', plpkName: 'Dede Rahmat', kecamatan: 'Garut Kota', village: 'Paminggir', status: 'handed-to-kordes', handoverDestination: 'kordes', createdAt: '2026-07-04', entries: [[12000], [7000], [25000], [5000], [18000], [9500]] },
  ...
  { period: '2026-06', plpkId: 'PLPK-01', plpkName: 'Dede Rahmat', kecamatan: 'Garut Kota', village: 'Ciwalen', status: 'handed-to-kordes', handoverDestination: 'kordes', createdAt: '2026-06-03', entries: [[16000], [9000], [7000], [21000], [5000], [12500], [8000]] },
  { period: '2026-06', plpkId: 'PLPK-02', plpkName: 'Asep Saepudin', kecamatan: 'Tarogong Kidul', village: 'Mekargalih', status: 'handed-to-kordes', handoverDestination: 'kordes', createdAt: '2026-06-04', entries: [[11500], [6000], [19000], [7000]] },
  ...
  { period: '2026-05', plpkId: 'PLPK-01', plpkName: 'Dede Rahmat', kecamatan: 'Garut Kota', village: 'Paminggir', status: 'handed-to-kordes', handoverDestination: 'kordes', createdAt: '2026-05-05', entries: [[18500], [7000], [10000], [23000], [6000], [14500], [9500], [5500]] },
  { period: '2026-05', plpkId: 'PLPK-02', plpkName: 'Asep Saepudin', kecamatan: 'Tarogong Kidul', village: 'Sukakarya', status: 'handed-to-kordes', handoverDestination: 'kordes', createdAt: '2026-05-07', entries: [[12000], [8500], [0, 'declined'], [16500]] },
  ...
  { period: '2026-04', plpkId: 'PLPK-01', plpkName: 'Dede Rahmat', kecamatan: 'Garut Kota', village: 'Sukamentri', status: 'handed-to-kordes', handoverDestination: 'kordes', createdAt: '2026-04-06', entries: [[15000], [6500], [19500], [8000], [7000]] },
  ...
  { period: '2026-04', plpkId: 'PLPK-02', plpkName: 'Asep Saepudin', kecamatan: 'Tarogong Kidul', village: 'Haurpanggung', status: 'handed-to-kordes', handoverDestination: 'kordes', createdAt: '2026-04-13', entries: [[11000], [7000], [17000]] },
  { period: '2026-03', plpkId: 'PLPK-04', plpkName: 'Ujang Koswara', kecamatan: 'Cilawu', village: 'Dawungsari', status: 'handed-to-kordes', handoverDestination: 'kordes', createdAt: '2026-03-09', entries: [[13000], [6000], [21500], [7000], [10500], [5000]] },
  { period: '2026-07', plpkId: 'PLPK-05', plpkName: 'Nia Solihat', kecamatan: 'Garut Kota', village: 'Paminggir', status: 'handed-to-kordes', handoverDestination: 'kordes', createdAt: '2026-07-09', entries: [[9500], [7000], [16000], [5500]] },
  { period: '2026-06', plpkId: 'PLPK-06', plpkName: 'Rudi Firmansyah', kecamatan: 'Garut Kota', village: 'Ciwalen', status: 'handed-to-kordes', handoverDestination: 'kordes', createdAt: '2026-06-11', entries: [[12000], [6500], [19000]] },
...
export const gorutCollectionBatches: CollectionBatch[] = seeds.map((seed, seedIndex) => {
  ...
  return {
    ...
    handedToKordesAt: seed.handoverDestination === 'kordes' ? seed.createdAt : undefined,
