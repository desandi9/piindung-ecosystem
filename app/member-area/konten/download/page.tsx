...
import { ArrowDown, ArrowLeft, ArrowUp, Eye, EyeOff, Plus, Save, Trash2, Upload } from "lucide-react"
...
export default function ManageDownloadPage() {
  ...
  useEffect(() => {
    if (isLoading) return
    if (!user) router.replace("/login?next=/member-area/konten/download")
