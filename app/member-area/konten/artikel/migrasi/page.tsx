...
import { AlertCircle, ArrowLeft, CheckCircle2, Eye, Info, PlayCircle, RefreshCcw, RotateCcw, Search, ShieldAlert, X } from "lucide-react"
    ...
    <div className="space-y-7 overflow-x-hidden">
      <motion.section variants={reveal} initial="hidden" animate="visible" className="rounded-[28px] border border-border bg-card p-6 shadow-sm sm:p-8">
        ...
        <div className="mt-5 flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
          ...
          <button disabled className="inline-flex min-h-11 items-center justify-center gap-2 rounded-xl bg-[#15945b] px-5 text-sm font-semibold text-white opacity-60"><PlayCircle className="h-4 w-4" /> Migrasi tersedia pada tahap berikutnya</button>
        </div>
      </motion.section>
