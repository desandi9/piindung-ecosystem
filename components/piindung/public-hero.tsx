...
export function HeroSection() {
  ...
  return (
    <section ref={sectionRef} id="beranda" className="relative isolate overflow-hidden bg-[#f7faf8] pb-14 pt-28 dark:bg-[#07131f] sm:pt-32 lg:min-h-[720px] lg:pb-20" aria-labelledby="hero-heading">
      ...
      <div className="relative mx-auto grid max-w-[1180px] items-center gap-10 px-6 sm:px-10 lg:grid-cols-[0.92fr_1.08fr] lg:gap-14">
        ...
        <motion.div style={{ y: visualY }} initial={reduced ? false : { opacity: 0, scale: 0.96 }} animate={{ opacity: 1, scale: 1 }} transition={{ duration: reduced ? 0 : 0.9, ease: motionEase, delay: reduced ? 0 : 0.18 }} className="relative hidden min-h-[455px] lg:block" aria-label={deviceVisual?.alt || "Pratinjau dashboard PIINDUNG versi demonstrasi"} data-content-image={deviceVisual?.image}>
          ...
          <div className="absolute left-5 top-10 w-[590px] max-w-[calc(100%-2rem)] overflow-hidden rounded-[24px] border border-white/80 bg-[#f9fcfa] shadow-[0_30px_80px_rgba(5,39,28,.2)] [transform:rotateY(-8deg)_rotateX(2deg)_rotate(1.2deg)] dark:border-white/10">
